...
description: Run Playwright tests or suites and upload the resulting report to Katalon True Platform. Use when Codex needs to execute Playwright scripts, package scripts, spec files, projects, or suites, configure or verify @katalon/playwright-reporter, upload Playwright reports with Katalon CLI/reporter commands, and verify uploaded Katalon Platform runs or reports.
---
...
- Whether Codex may modify Playwright config/package files if the Katalon reporter is missing.
